...
try:
    ...
    #open("/var/lib/ceph/mon/ceph-{}/upstart".format(current_node_name),'w+').close()
    #if not call_cmd("start ceph-mon id={} ".format(current_node_name)) :
        #raise Exception("Error executing  start mon {}".format(current_node_name))
