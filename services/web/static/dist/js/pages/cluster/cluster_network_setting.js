    ...
    if ($('#vlan_tagging_backend1').prop('checked')){
        ...
        if(vlan_backend1_id){
            if(vlan_backend1_id < 1 || vlan_backend1_id > 4094){
                ...
                $('#vlan_tagging_backend1').closest('.form-group').addClass('has-error');
                $('#vlan_tagging_backend1').focus();
    ...
    if ($('#vlan_tagging_backend2').prop('checked')){
        ...
        if(vlan_backend2_id){
            if(vlan_backend2_id < 1 || vlan_backend2_id > 4094){
                ...
                $('#vlan_tagging_backend2').closest('.form-group').addClass('has-error');
                $('#vlan_tagging_backend2').focus();
                event.preventDefault();
            }else{
