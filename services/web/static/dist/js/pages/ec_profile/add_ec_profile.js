...
var jerasure_techniques = ['reed_sol_van' , 'reed_sol_r6_op' , 'cauchy_orig' , 'cauchy_good' , 'liberation' , 'blaum_roth' , 'liber8tion'];
var isa_techniques = ['reed_sol_van' , 'cauchy'];
var techniques = ['reed_sol_van' , 'reed_sol_r6_op' , 'cauchy_orig' , 'cauchy_good' , 'liberation' , 'blaum_roth' , 'liber8tion' , 'cauchy'];
var optional_tags = ['plugin' , 'technique' , 'stripe_unit' , 'packet_size' , 'locality' , 'durability_estimator'];
var hidden_tags_ids = ['#technique_div' , '#packet_size_div' , '#locality_div' , '#durability_estimator_div'];
var plugins_related_fields = ['technique' , 'packet_size' , 'durability_estimator' , 'locality'];
